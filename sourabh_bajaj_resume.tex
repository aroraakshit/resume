...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Thapar University (TU)}{Patiala, India}
...
\section{Programming Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Tools}{Palisade Decision Tools (@RISK \& Evolver), NeuLog API, InquisitLab, Qualtrics}
  \resumeSubHeadingListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Interactive Landslide Simulator (ILS)}
          {Developed a web-based research tool to balance public risk perceptions and how people at risk could adapt, to and mitigate the landslides in their neighbourhood.  \href{http://pratik.acslab.org/}{pratik.acslab.org}}
        \resumeItem{Marker-based and GPS-based Augmented Reality (AR)}
          {Explored various libraries for AR based application development including, Google Tango, Microsoft Holo-lens, Wikitude SDK, ARToolkit \& KudanAR.\newline Built a tool (android application) for training military personnel in different cognitive loads. Responsible for making AR simulations similar to scavenger hunt and first-person-shooter games using Vuforia.}
         ...
         \resumeItem{Research}
         {Gave oral presentations in 3 domestic and 1 international conferences. Wrote 1 Journal Paper and 1 Book Chapter (see details in the Projects section)}
      \resumeItemListEnd
      ...
      \resumeItemListStart
        \resumeItem{Teaching Assistant - The Art of Computational Thinking}
          {Responsible for conducting lab sessions, holding office hours, interview-based grading, solving doubts and prepare assignments for 200+ students.}
        \resumeItem{Grader - Human-Centered Computing}
          {Responsible for grading assignments for 150+ students.}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
